    ...
    <div class="mx-auto mt-5 card md:w-1/2">
        ...
        <form action="{{ route('sales.store') }}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="created_at" id="created_at" class="input" value="{{ old('created_at') }}">
                @error('created_at')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="total_amount" id="total_amount" class="input" value="{{ old('total_amount') }}">
                @error('total_amount')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
