        ...
        <form action="{{ route('products.update', $product) }}" method="post">
            ...
            <div class="mb-4">
                ...
                <select name="category" id="category" class="input">
                    <option value="Medications" {{ $product->category == 'Medications' ? 'selected' : '' }}>Medications</option>
                    ...
                    <option value="Medical Equipment" {{ $product->category == 'Medical Equipment' ? 'selected' : '' }}>Medical Equipment</option>
                    <option value="Baby Products" {{ $product->category == 'Baby Products' ? 'selected' : '' }}>Baby Products</option>
                    <option value="Health Devices" {{ $product->category == 'Health Devices' ? 'selected' : '' }}>Health Devices</option>
                    <option value="Homeopathic Remedies" {{ $product->category == 'Homeopathic Remedies' ? 'selected' : '' }}>Homeopathic Remedies</option>
                    <option value="Herbal Products" {{ $product->category == 'Herbal Products' ? 'selected' : '' }}>Herbal Products</option>
                    ...
                    <option value="Oral Care" {{ $product->category == 'Oral Care' ? 'selected' : '' }}>Oral Care</option>
                    <option value="Sexual Health" {{ $product->category == 'Sexual Health' ? 'selected' : '' }}>Sexual Health</option>
